...
export function Model(props) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.Room_365.geometry} material={materials.Wall_material} position={[-3.31, 0.02, -2.47]}>
      ...
      <mesh geometry={nodes['Room_303,_304,_305'].geometry} material={materials.Wall_material} position={[-0.42, 0, -1.78]} rotation={[0, 0.86, 0]}>
        <mesh geometry={nodes.Floor021.geometry} material={materials.Floor_material} position={[0, 0.01, 0]} />
      </mesh>
      <mesh geometry={nodes.Room_316.geometry} material={materials.Wall_material} position={[-0.9, 0, -0.5]} rotation={[0, Math.PI / 4, 0]}>
        <mesh geometry={nodes.Floor014.geometry} material={materials.Floor_material} position={[0, 0.02, 0]} />
      </mesh>
      <mesh geometry={nodes['Room_312-313'].geometry} material={materials.Wall_material} position={[-0.18, 0, -1.14]} rotation={[0, Math.PI / 4, 0]}>
        <mesh geometry={nodes.Floor013.geometry} material={materials.Floor_material} position={[0, 0.02, 0]} />
      </mesh>
      <mesh geometry={nodes['Room_308-311'].geometry} material={materials.Wall_material} position={[0.32, 0, -2.17]} rotation={[0, Math.PI / 4, 0]}>
      ...
      <mesh geometry={nodes.Room_320.geometry} material={materials.Wall_material} position={[-1.44, 0, 0.46]}>
        <mesh geometry={nodes.Floor016.geometry} material={materials.Floor_material} position={[0, 0.01, 0]} />
      </mesh>
      <mesh geometry={nodes.Room_301.geometry} material={materials.Wall_material} position={[-1.51, 0, -0.81]}>
      ...
      <mesh geometry={nodes.Room_318.geometry} material={materials.Wall_material} position={[-1.42, 0, 0.27]}>
        <mesh geometry={nodes.Floor015.geometry} material={materials.Floor_material} position={[0, 0.01, 0]} />
      </mesh>
